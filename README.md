# 暂缓更新
由于Horizon在开发时候未考虑到后续内容的发布和更新，且目前的进度仅为测试数据来测试效果，所以现在暂缓Horizon的更新。

请在部署该项目时注意，测试数据请勿二次修改后外传。

# 关于项目
Horizon没有使用Node或其他服务端项目，单纯使用Vue3+Picocss+原生Javascript开发。如果你需要部署该项目，并需要实现更多功能，建议使用Node或服务端语言配合开发。
...
# 版权声明
Turbo Flint虽暂停了开源项目业务，但其内容仍归属于Turbo Flint。请勿用于商业用途。
